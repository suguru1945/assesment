...
function assesment () {
    ...
    // <a href="https://twitter.com/intent/tweet?button_hashtag=あなたのいいところ&ref_src=twsrc%5Etfw" class="twitter-hashtag-button"　date-text="診断結果の文章"></a>
    anchor.setAttribute('data-text', result);
    // <a href="https://twitter.com/intent/tweet?button_hashtag=あなたのいいところ&ref_src=twsrc%5Etfw" class="twitter-hashtag-button"　date-text="診断結果の文章">Tweet #あなたのいいところ</a>
...
function assessment(userName) {
    ...
    // 文字のコード番号の番号の合計を回答の数で割って添字の数値を求める
